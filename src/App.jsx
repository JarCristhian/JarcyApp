...
const App = () => {
  ...
  return (
    <>
      <div className="static h-screen w-screen overflow-x-hidden overflow-y-scroll scrollbar bg-slate-100 dark:bg-body">
        <header>
          <div id="home" className="container absolute shadow-2xl">
            <NavBar />
          </div>
        </header>
        <SideBar />
        ...
        <div id="experience" className="w-screen  flex items-center justify-center mb-52">
          <Work />
        </div>
        ...
        <div id="contact">
          ...
          <div className="flex justify-center items-center ml-3 mb-12 mt-12">
          ...
          <div className="flex mt-4 justify-center items-center h-14 border-t border-gray-800 text-gray-600 dark:text-white/40">
            Created by Jarcy ©
          </div>
        </div>
      </div>
