          ...
          <motion.div className="grid gap-4 sm:grid-cols-3 select-none" variants={textAnimate}>
            <div className="dark:bg-gray-800/30 rounded-lg shadow-2xl transition ease-out hover:-translate-y-2">
              ...
              <div className="relative pb-36">
                <img src="./public/projects/jPlayer.png" className="rounded-b-lg select-none absolute h-full w-full object-cover" />
              </div>
            </div>
            <div className="dark:bg-gray-800/30 rounded-lg shadow-2xl transition ease-out hover:-translate-y-2">
              ...
              <div className="relative pb-36">
                <img src="./public/projects/asiTable.png" className="rounded-b-lg select-none absolute h-full w-full object-cover" />
              </div>
            </div>
            <div className="dark:bg-gray-800/30 rounded-lg shadow-2xl transition ease-out hover:-translate-y-2">
              ...
              <div className="relative pb-36">
                <img src="./public/projects/faqture/white.png" className="rounded-b-lg select-none absolute h-full w-full object-cover" />
              </div>
            </div>
            <div className="dark:bg-gray-800/30 rounded-lg shadow-2xl transition ease-out hover:-translate-y-2">
              ...
              <div className="relative pb-36">
                <img src="./public/projects/awaBW.png" className="rounded-b-lg select-none absolute h-full w-full object-cover" />
              </div>
            </div>
          </motion.div>
        </div>
